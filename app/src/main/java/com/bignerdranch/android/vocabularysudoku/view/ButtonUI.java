...
public class ButtonUI {
    ...
    private GridLayout.LayoutParams createSudokuCellButtonParameters(int indexI, int indexJ){
        ...
        if (indexI % (int)floor(sqrt(sSize)) == 0) {
            layoutParameters.setMargins(layoutParameters.leftMargin,8,layoutParameters.rightMargin,layoutParameters.bottomMargin);
        }
        if (indexJ % (int)ceil(sqrt(sSize)) == 0) {
            layoutParameters.setMargins(8,layoutParameters.topMargin,layoutParameters.rightMargin,layoutParameters.bottomMargin);
        }
